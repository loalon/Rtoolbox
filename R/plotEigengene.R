...
#' Description
#'
#' @param data Samples in rows, genes in columns
...
#' @param multiline
#' @param legendTitle
#' @param plotBothProfiles
#'
#' @export
plotEigengene <- function(data, genes, yVector, xVector, xUnits = "Time",
                          inverse = F, title = "", grid = F, colors = c("#009444", "#BE9230"),
                          legend=T, multiline = F, legendTitle="",
                          plotBothProfiles=F) {
